...
export default JSWooF.App1 = class extends App {
     ...
     */
    run() {
        const div = document.getElementById("mainContent");         // Set the brief description text
        const tmpParagraph = document.createElement("p");
        const tmpTextNode = document.createTextNode("Welcome to JSWooF! (JavaScript Web object-oriented Framework).  " +
